globals
    // Generated
rect gg_rct_HeroSpawnMid= null
rect gg_rct_HeroSpawnNorth= null
rect gg_rct_HeroSpawnEast= null
rect gg_rct_HeroSpawnSouth= null
rect gg_rct_SpwnA000= null
rect gg_rct_SpwnA001= null
rect gg_rct_SpwnB000= null
rect gg_rct_SpwnB001= null
rect gg_rct_SpwnA002= null
rect gg_rct_SpwnA003= null
rect gg_rct_SpwnA004= null
rect gg_rct_SpwnB002= null
rect gg_rct_SpwnB003= null
rect gg_rct_SpwnA005= null
rect gg_rct_SpwnB004= null
rect gg_rct_SpwnB005= null
rect gg_rct_SpwnB006= null
rect gg_rct_SpwnA006= null
rect gg_rct_SpwnB007= null
rect gg_rct_SpwnA007= null
rect gg_rct_SpwnB008= null
rect gg_rct_SpwnB009= null
rect gg_rct_SpwnA008= null
rect gg_rct_SpwnA009= null
...
//===========================================================================
// 
// Heroes and Empires 2018.4.17
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Sat Nov 23 13:50:10 2019
//   Map Author: Halithor
// 
//===========================================================================
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'Hpal', 401.5, - 222.9, 240.454)
    set u=CreateUnit(p, 'Hpal', - 182.2, 384.0, 252.232)
    set u=CreateUnit(p, 'hpea', 381.5, 269.8, 145.650)
    set u=CreateUnit(p, 'hpea', - 9.7, - 230.0, 161.636)
    set u=CreateUnit(p, 'hpea', - 183.0, 155.7, 340.795)
endfunction
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_HeroSpawnMid=Rect(- 2816.0, - 1152.0, - 2208.0, - 672.0)
    set gg_rct_HeroSpawnNorth=Rect(0.0, 8608.0, 576.0, 9056.0)
    set gg_rct_HeroSpawnEast=Rect(8768.0, - 1088.0, 9120.0, - 576.0)
    set gg_rct_HeroSpawnSouth=Rect(5696.0, - 9536.0, 6176.0, - 9152.0)
    set gg_rct_SpwnA000=Rect(- 8000.0, 7328.0, - 7456.0, 7936.0)
    set gg_rct_SpwnA001=Rect(- 8160.0, 1536.0, - 7776.0, 1920.0)
    set gg_rct_SpwnB000=Rect(- 8576.0, 4448.0, - 8192.0, 4864.0)
    set gg_rct_SpwnB001=Rect(1600.0, 7680.0, 1888.0, 8064.0)
    set gg_rct_SpwnA002=Rect(384.0, - 4736.0, 1024.0, - 4096.0)
    set gg_rct_SpwnA003=Rect(- 4608.0, - 6624.0, - 4128.0, - 6112.0)
    set gg_rct_SpwnA004=Rect(- 2496.0, - 4096.0, - 2112.0, - 3712.0)
    set gg_rct_SpwnB002=Rect(- 1440.0, - 1728.0, - 960.0, - 1312.0)
    set gg_rct_SpwnB003=Rect(- 160.0, - 384.0, 288.0, 96.0)
    set gg_rct_SpwnA005=Rect(3040.0, - 2144.0, 3616.0, - 1472.0)
    set gg_rct_SpwnB004=Rect(3840.0, - 4224.0, 4256.0, - 3808.0)
    set gg_rct_SpwnB005=Rect(- 1856.0, - 7264.0, - 1408.0, - 6688.0)
    set gg_rct_SpwnB006=Rect(- 4320.0, - 9248.0, - 4000.0, - 9056.0)
    set gg_rct_SpwnA006=Rect(- 7648.0, - 8640.0, - 7072.0, - 8192.0)
    set gg_rct_SpwnB007=Rect(- 4384.0, - 1600.0, - 3936.0, - 1024.0)
    set gg_rct_SpwnA007=Rect(4064.0, 192.0, 4640.0, 864.0)
    set gg_rct_SpwnB008=Rect(2880.0, 4160.0, 3296.0, 4672.0)
    set gg_rct_SpwnB009=Rect(- 2464.0, 1344.0, - 2048.0, 2016.0)
    set gg_rct_SpwnA008=Rect(96.0, 4480.0, 736.0, 5184.0)
    set gg_rct_SpwnA009=Rect(- 7712.0, - 5856.0, - 7008.0, - 5184.0)
endfunction
...
function InitCustomPlayerSlots takes nothing returns nothing
    ...
    call SetPlayerRacePreference(Player(21), RACE_PREF_UNDEAD)
...
function InitAllyPriorities takes nothing returns nothing
    ...
    call SetStartLocPrioCount(1, 20)
    ...
    call SetStartLocPrioCount(2, 20)
    ...
    call SetStartLocPrioCount(3, 20)
    ...
    call SetStartLocPrioCount(4, 20)
    ...
    call SetStartLocPrioCount(5, 20)
    ...
    call SetStartLocPrioCount(6, 20)
    ...
    call SetStartLocPrioCount(7, 20)
    ...
    call SetStartLocPrioCount(8, 20)
    ...
    call SetStartLocPrioCount(10, 20)
    ...
    call SetStartLocPrioCount(12, 20)
    ...
    call SetStartLocPrioCount(13, 20)
    ...
    call SetStartLocPrioCount(14, 20)
    ...
    call SetStartLocPrioCount(15, 20)
    ...
    call SetStartLocPrioCount(16, 20)
    ...
    call SetStartLocPrioCount(17, 20)
    ...
    call SetStartLocPrioCount(18, 20)
    ...
    call SetStartLocPrioCount(19, 20)
    ...
    call SetStartLocPrioCount(20, 20)
    ...
    call SetStartLocPrioCount(21, 22)
    ...
    call SetStartLocPrioCount(22, 22)
